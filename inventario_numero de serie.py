...
""" script que crea un ajuste de inventario desde un numero de serie,
se selecciona el ID de la forma no compatible del numero de serie ya creado.
"""
...
def _create(estado):
    if estado is True:
        path_file = './inventario_numero de serie.csv'
